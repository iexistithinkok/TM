...
window.__SUPABASE_URL__ = window.__SUPABASE_URL__ || "https://odbcpoxlapcxzwiqjmyw.supabase.co";
window.__SUPABASE_ANON_KEY__ = window.__SUPABASE_ANON_KEY__ || "sb_publishable_uPFq7zPYedEfaMOdleSSKg_LvSowQE-";
